...
2. Auth endpoints:
   - `POST /v1/projects/{projectID}/reports/{reportID}/shares` — **project owner**
   - `GET /v1/projects/{projectID}/reports/{reportID}/shares` — project member
   - `DELETE /v1/projects/{projectID}/shares/{shareID}` (revoke) — **project owner**
